...
- [[exercises/ethical-prompting/ep-advanced-01|The AI Governance Playbook]] — Design team-level AI guidelines (strategic impact)
- [[exercises/insight-synthesis/is-basic-01|The Signal in the Noise]] — Extract meaning from AI output (a skill that multiplies everything else)
- [[exercises/workflow-automation/wa-advanced-01|The Workflow Blueprint]] — Design a complete AI-assisted workflow
...
If you want a structured route, try [[pathways/high-synthesis-low-agent|High Synthesis, Low Agent Collaboration]] — it builds from your analytical strength into more hands-on agent work.
