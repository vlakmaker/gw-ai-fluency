...
description: "What AI fluency means and why it matters for generalists."
tags: [guide]
---
...
1. **Jump into an exercise** — [[exercises/ethical-prompting/ep-basic-01|The Fact-Check Habit]] is a great first one. It takes 15 minutes and you'll learn something immediately.

2. **Take the AI Skills Quiz** — Visit [aiskillsquiz.com](https://aiskillsquiz.com) to discover your strengths and get a personalized starting point.

3. **Read the overview** — Check out [[pillars/_index|The Five Pillars]] to understand the full framework before diving in.

Whatever you choose, you're already doing the most important thing: showing up and being willing to learn.

Next: [[how-to-use|How to Use This Playbook]]
