...
description: "Three ways to navigate the AI Fluency Playbook, plus tips for getting the most out of it."
tags: [guide]
---
...
- [[exercises/ethical-prompting/ep-basic-01|The Fact-Check Habit]] — Learn to catch AI mistakes (a skill you'll use every day)
- [[exercises/insight-synthesis/is-basic-01|The Signal in the Noise]] — Turn messy AI output into clear insight
- [[exercises/workflow-automation/wa-basic-01|The Reusable Prompt]] — Build your first reusable AI template
...
1. Read [[pillars/_index|The Five Pillars]] to understand what AI fluency is made of
2. Browse the [[levels/_index|Levels]] to see how skills progress from Basic to Advanced
...
Ready? Pick a path above, or head back to the [[index|home page]] to explore.
