...
1. **Find your archetype** in the [Archetypes](/archetypes/) section to understand your learning style
2. **Check the [Pathways](/pathways/)** for a guided route matched to your profile
...
- **Jump in** — For [Tinkerers](/archetypes/tinkerer/). Start doing, then understand why.
- **Plan first** — For [Planners](/archetypes/planner/). Read the overview, then execute step by step.
- **Why this matters** — For [Strategists](/archetypes/strategist/). Understand the strategic value before starting.
- **Discuss** — For [Social Learners](/archetypes/social-learner/). Use the reflection prompts with a colleague or community.
