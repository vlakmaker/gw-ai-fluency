...
1. Start with [AC-Basic-01](/exercises/agent-collaboration/ac-basic-01/) — Get your feet wet with agent-based thinking
2. Then [AC-Intermediate-01](/exercises/agent-collaboration/ac-intermediate-01/) — Apply your synthesis skills to multi-agent output
3. Then [IS-Intermediate-01](/exercises/insight-synthesis/is-intermediate-01/) — Level up your strongest pillar
4. Stretch: [AC-Advanced-01](/exercises/agent-collaboration/ac-advanced-01/) — Design an agent workflow
...
- **Skipping the basic agent exercise.** If you score high on Insight Synthesis, you may feel that [AC-Basic-01](/exercises/agent-collaboration/ac-basic-01/) is beneath you. It's not. The exercise introduces a mental model (role-based AI interaction) that's fundamentally different from single-query synthesis work. Don't skip the foundation.
