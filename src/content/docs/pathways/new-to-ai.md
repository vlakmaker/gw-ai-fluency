...
1. Start with [The Fact-Check Habit](/exercises/ethical-prompting/ep-basic-01/) — This is the single most important skill in AI fluency: learning to verify what AI tells you. It's quick, eye-opening, and you'll use it every time you work with AI from now on.
2. Then [The Signal in the Noise](/exercises/insight-synthesis/is-basic-01/) — Learn to pull useful information out of verbose AI responses. This makes every future AI interaction more productive.
3. Then [The Reusable Prompt](/exercises/workflow-automation/wa-basic-01/) — Turn something you do regularly into a prompt template. This is where AI starts saving you real time.
4. Then branch out: [The Stolen Technique](/exercises/cross-domain-reframing/cdr-basic-01/) — Try borrowing a technique from a different field. This exercise expands how you think about AI's possibilities.
5. Stretch: [Your First AI Team Meeting](/exercises/agent-collaboration/ac-basic-01/) — Once you're comfortable with the basics, try working with AI in multiple roles. This is a glimpse of where AI is heading.
