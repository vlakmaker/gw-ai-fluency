...
1. Start with [EP-Basic-01](/exercises/ethical-prompting/ep-basic-01/) — Establish a baseline for checking AI output
2. Then [EP-Intermediate-01](/exercises/ethical-prompting/ep-intermediate-01/) — Build verification into your workflows
3. Then [WA-Intermediate-01](/exercises/workflow-automation/wa-intermediate-01/) — Level up automation with ethics baked in
4. Stretch: [EP-Advanced-01](/exercises/ethical-prompting/ep-advanced-01/) — Design an accountability system
...
- **Resisting the checklist.** If you're the type who builds systems, using someone else's checklist feels awkward. But [EP-Intermediate-01](/exercises/ethical-prompting/ep-intermediate-01/) asks you to build *your own* — customized to your work, tested against real outputs, and integrated into your existing workflows.
